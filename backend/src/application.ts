...
import { getAccountAsset, saveAccountAsset, saverOrder, updateAccountAsset, getOrderById, getAccountById, getAccountAssets } from "./resource";


export async function deposit(input: any) {
  await saveAccountAsset(input.accountId, input.assetId, input.quantity)
}
